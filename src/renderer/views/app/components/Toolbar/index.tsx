...
export const Toolbar = observer(() => {
  return (
    <StyledToolbar
      docked={store.settings.object.leftDockTabs}
      style={{ paddingRight: store.settings.object.leftDockTabs ? 140 : 0 }}
    >
      {!store.isCompact && store.settings.object.leftDockTabs && (
        <DockLeftButton />
      )}
      <NavigationButtons />
      <AddressBar />
