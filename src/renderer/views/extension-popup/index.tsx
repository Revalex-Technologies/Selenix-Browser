// The native remote module has been removed from Electron. Use the
// @electron/remote package instead, and import ipcRenderer separately.
import { ipcRenderer } from 'electron';
import type { Event, ContextMenuParams, WebContents } from 'electron';
...
const createWebview = (url: string, inspect: boolean) => {
  ...
  webview.addEventListener('dom-ready', () => {
    remote.webContents
      ...
      .addListener('context-menu', (e: Event, params: ContextMenuParams) => {
